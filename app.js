...
const app = {
    ...
    calcDeuda() {
        ...
        if(deuda < 0) alert("El abono no puede ser mayor al total.");
    },
    ...
    async loadDashboardData() {
        ...
        try {
            ...
            console.error(error);
            alert("Error conectando con Google Sheets. Verifica la URL y los permisos CORS.");
        }
    ...
    async submitForm(event, sheetName) {
        ...
        if(sheetName === 'Ventas'){
            ...
            if(abono > total) return alert("El abono no puede superar el Total.");
        }
        ...
        } catch (error) { console.error(error); alert("Error en el envío de datos."); }
        this.setLoading(false);
    },
    ...
    async submitAbono(event) {
        ...
        try {
            ...
            if(result.status === 'success'){
                form.reset();
                this.toggleModal('modal-abono');
                await this.loadDashboardData(); // Refrescar todo (saldos y finanzas)
            }
    ...
    calculateFinancials() {
        ...
        // Sumar todos los saldos pendientes para saber cuánto hay en la calle
        ...
        this.chartInstance = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    ...
                    { label: 'Egresos', data: [egresos], backgroundColor: 'rgba(239, 68, 68, 0.8)' }
                ]
            },
